#a quick shell script for running our experiments for CRFs
get_data() {
  echo ""
  ...
  #repeat the process for training set sizes 100 through 1300, incrementing by 300
  for ((k=100; k <= 1300; k=k+300)) do
    ...
    for ((trial=1; trial<4; trial=trial+1)) do
      ...
      cd ..
        ...
        #repeat the above incrementations of training size for a CRF model of 3
  echo ""
